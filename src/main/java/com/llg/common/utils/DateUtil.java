...
public class DateUtil {
	...
	public static final String DATECHINESE = "yyyy年M月d日";
	...
	public static final String YY_MM = "yyyy-MM";// 新增时间格式
	 ...
	 */
	public static boolean compareDate(String beginDate, String endDate, String compareDate) throws ParseException {
	...
	/**
	 * 获取当前时间str，格式yyyyMMddHHmmssssss 精确到毫秒
	 *
	 * @return
	 * @author guoyx
	 */
	...
	public static Date getCurrentDateTime(String format) {
		...
		try {
			...
			Date date = new Date();
			date = dataFormat.parse(dataFormat.format(date));
			return date;
		} catch (Exception e) {
	 ...
	 * @return
	 */
	public static String getCurrentDateTimeToNami() {
		SimpleDateFormat dataFormat = new SimpleDateFormat("yyyyMMdd");
		Date date = new Date();
		String timeString = dataFormat.format(date);
		return timeString + String.valueOf(System.nanoTime());
	}
...
//	}
	 ...
	 * @return
	 */
    public static long dateIntervalMin(Date start, Date end){
...
//		long hour = diff/(1000 * 60 * 60);						计算差多少小时
	 ...
	 * @param dateStr
	 */
	public static Date parseStringToFullDate(String dateStr){
		SimpleDateFormat simpleDateFormat = new SimpleDateFormat(fullDate);
	 ...
	 * @return
	 */
	public static int differentDays(String date1Str, Date date1, Date date2) {
		if (date1 == null) {
			date1 = parseStringToDate(date1Str);
		}
	 ...
	 * @return
	 */
	public static String parseChineseDate(String dateStr) {
		SimpleDateFormat format = new SimpleDateFormat(DATECHINESE);
	...
	public static Integer compareDate(Date date1, Date date2) {
		try {
			...
			Date dt1 =null;
			Date dt2 = null;
			dt1 = simpleDateFormat.parse(simpleDateFormat.format(date1));
			dt2 = simpleDateFormat.parse(simpleDateFormat.format(date2));
	 ...
	 * @return
	 */
	public static Date getDateByTimeStamp(String timestampString, String formats) {
		try {
			Long timestamp = Long.parseLong(timestampString)*1000;
			 String date = new SimpleDateFormat(formats).format(new Date(timestamp));
	 ...
	 * @date 2018年1月12日
	 * @version 1.0
	 * @param dateStr 所有时间字符串
	 * @return
	 * @throws ParseException
	 */
	public static int compareDate(String dateStr) throws ParseException {
	 ...
	 * @throws ParseException
	 */
	public static long compareDateBetweenDay(String date)
			throws ParseException {
		...
		long btw = end.getTime() - start.getTime();
		long day = btw/(24*3600*1000);
	 ...
	 * @throws ParseException
	 */
	public static int compareDay(String dateStr) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Date date1 = sdf.parse(dateStr);
		Date date2 = sdf.parse(sdf.format(new Date()));
	 ...
	 * @throws ParseException
	 */
	public static boolean compareDays(Date date) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
		Date date1 = sdf.parse(sdf.format(date));
		Date date2 = sdf.parse("2018-05-14");
		long days = (date2.getTime()-date1.getTime())/(24*3600*1000);
		if(days>=1) {
			return true;
		}else {
	 ...
	 * @throws ParseException
	 */
	public static int compareDate2(String dateStr) throws ParseException {
		SimpleDateFormat sdf = new SimpleDateFormat(fullDate);
		Date date1 = sdf.parse(dateStr);
		String date2Str = sdf.format(new Date());
		date2Str = date2Str.split(" ")[0]+=" 00:00:00";
	 ...
	 * @param dateEnd
	 * @param dateStart
	 * @return  dateEnd > dateStart : 1  ,dateEnd > dateStart ：0， dateEnd < dateStart : -1
	 */
	public static int compareTwoDate(Date dateEnd, Date dateStart){
	 ...
	 * @throws Exception
	 */
	public static long getMinutesFromTwoDate(String date1,String date2) throws Exception {
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
		Date d1 = sdf.parse(date1);
		Date d2 = sdf.parse(date2);
		long val =  d2.getTime()-d1.getTime();
		long minute = (val/1000)/60;
		return minute;
	}
	...
	/**
	 * 判断当前系统时间是否在时间区间
	 * @param begin 区间开始时间	"05:00"
	 * @param end	区间结束时间 "23:30"
	 * @return
	 */
...
//		System.out.println(differentDays("2017-11-02",null,new Date()));
//		System.out.println("11114567".substring("11114567".length() - 4));
//		System.out.println(parseChineseDate("2017-11-02"));
//		//compareDate(new Date(),null,"2017-10-01");
//		System.out.println(getSysDate(DateUtil.DATE));
//
//
//		System.out.println(parseStringToFullDate("2017-12-08"));
//		double cc = 0.00;


//		SimpleDateFormat sdf = new SimpleDateFormat(fullDate);
//		Date date = sdf.parse("2018-04-18 00:00:00");
//
//		System.out.println(compareTwoDate(date,new Date()));
...
//		System.out.println(calendar.getTime());
		...
		//System.out.println(compareDate("2018-05-07"));
//		System.out.println(compareDate2("2018-03-15 00:00:00"));
//
//		Date date = DateUtil.getCurrentDateTime("");
//		Date date2 = DateUtil.getCurrentDateTime();
//		System.out.println(date);
//		System.out.println(date2);
//
//
//		String dateStr = "20180401";
//		String format="yyyyMMdd";
//		Date date3 = DateUtil.getDateByStr(dateStr, format);
